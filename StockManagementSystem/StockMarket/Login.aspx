                            ...
                            <div class="tab-pane active" id="register-acct">
                                <div class="row-fluid">
                                    <div class="span6">
                                        ...
                                        <asp:TextBox ID="txtCompanyName" runat="server" CssClass="input-block-level"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtCompanyName" ErrorMessage="Company Name" ValidationGroup="Register" Display="None" />
                                        <asp:RegularExpressionValidator runat="server" ID="revCompanyName" ControlToValidate="txtCompanyName" ErrorMessage="Company Name" Display="None" ValidationGroup="Register" />
